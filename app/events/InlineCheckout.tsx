...
// Eventbrite sets the iframe to this fixed pixel height (no auto-resize), so
// make it tall enough to fit the whole flow and avoid an inner scrollbar.
const CHECKOUT_HEIGHT = 1100
...
export default function InlineCheckout({ eventId }: { eventId: string }) {
    ...
    loadEbWidgets()
      .then(() => {
        ...
        window.EBWidgets.createWidget({
          ...
          iframeContainerHeight: CHECKOUT_HEIGHT,
          themeSettings: {
  ...
  return <div id={containerId} className="w-full" style={{ minHeight: CHECKOUT_HEIGHT }} />
}