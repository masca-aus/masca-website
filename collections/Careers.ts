...
export const Careers: CollectionConfig = {
  ...
  fields: ([
    ...
    { name: 'lifecycle', type: 'text', virtual: true, admin: { components: { Field: false, Cell: '/components/admin/CareerLifecycleCell#CareerLifecycleCell' }, disableBulkEdit: true }, hooks: { afterRead: [async ({ data, req }: Parameters<FieldHook>[0]) => {
