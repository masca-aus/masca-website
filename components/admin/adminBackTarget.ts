const labels: Record<string, string> = { careers: 'Careers', organisations: 'Organisations', committee: 'Committee', events: 'Events', media: 'Media', sponsors: 'Sponsors', users: 'Users' };
