...
export function CareerListTools() {
  ...
  </nav></SectionToolbar>{view === 'archived' && <p>Archived opportunities are kept for your records. Restore an opportunity to return it to the other lists, or select archived opportunities and choose Delete to permanently remove them and their change history.</p>}{view === 'closed' && <p>Closed opportunities are hidden from the public board. Reopen an opportunity when applications resume.</p>}</div>;
}
